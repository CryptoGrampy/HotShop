...
<template>
    ...
    <p>HotShop, along with other browser-based Monero webapps that communicate
    ...
    <el-row>
        <div v-if="nodeWorks !== null">
            ...
            <p v-else="!nodeWorks">
                ...
                This node is NOT browser compatible. Please review the node config instructions above.
            </p>
        </div>
    </el-row>
</template>
